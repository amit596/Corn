...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002471953287 -1002332320517')) # 
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+U9ABfC7hu1EyZjU1') #Support group link ( make sure bot is admin )
#---------------------------------------------------------------
#---------------------------------------------------------------
IS_VERIFY = is_enabled('IS_VERIFY', True)
#---------------------------------------------------------------
TUTORIAL = environ.get("TUTORIAL", "https://t.me/akhowtoopenlinks/41")
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/akhowtoopenlinks/35")
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/akhowtoopenlinks/41")
